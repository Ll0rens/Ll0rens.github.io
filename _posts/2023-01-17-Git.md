...
Initialize the repository without a README file (If you have already a README file or any other commit in the repository, you need to do a git pull first, if not you will receive error: Updates were rejected because the tip of your current branch is behind)
